...
//    -Fixed a critical issue that may make the shadow fail to work under
//     certain conditions, e.g., on Win2000, on WinXP or Win2003 without the
//     visual theme enabled, or when the frame window does not have a caption
//     bar.
//
